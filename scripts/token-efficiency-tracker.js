...
if (require.main === module) {
  ...
  switch (command) {
    ...
    case "report":
      tracker
        ...
        .then((result) => {
          ...
          console.log("========================")
          console.log(`Total Tokens Used: ${result.report.total_tokens_used}`)
          console.log(`Total Tokens Saved: ${result.report.total_tokens_saved}`)
          console.log(`Average Efficiency: ${result.report.avg_efficiency?.toFixed(1)}%`)
          console.log(
            `Sub-agent Usage: ${result.report.sub_agent_sessions}/${result.report.total_sessions}`,
          )
    ...
    default:
      console.log("Usage:")
      console.log(
        '  node token-efficiency-tracker.js track "task description" tokens_used tokens_saved method sub_agent',
      )
      console.log("  node token-efficiency-tracker.js report")
  }
}
