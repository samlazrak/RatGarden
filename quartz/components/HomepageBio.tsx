...
export default ((opts?: Partial<Options>) => {
  ...
  const HomepageBio: QuartzComponent = ({ 
    ...
    const quickLinks = [
      { title: "Current Research", slug: "research/PhD", description: "AI in Medicine & Biomedical Engineering" },
      { title: "Publications", slug: "research/Publications", description: "Research publications and papers" },
      { title: "Art Projects", slug: "art/My-Art", description: "Mixed-media and digital art" },
      { title: "Community Work", slug: "projects/Build-Birmingham", description: "Tech community building" },
    ]
          ...
          <div class="quick-links">
            ...
            <div class="quick-links-grid">
              {quickLinks.map((link, index) => {
                const relativeUrl = resolveRelative(fileData.slug!, link.slug)
                return (
                  <a 
                    key={index}
                    href={relativeUrl} 
